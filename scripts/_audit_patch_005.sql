...
VALUES (
  ...
  jsonb_build_object(
    ...
    'changes', jsonb_build_array(
      ...
      'likert_labels_official',
      'bloco_1_tipo_vinculo_official',
      'bloco_1_tempo_empresa_official',
      'perguntas_abertas_4_official',
    ...
    'remaining_for_v1_1', jsonb_build_array(
      'rewrite_80_questions_official',
      'reverse_scored_all_true',
      'macro_micro_laudos_official_50_5',
