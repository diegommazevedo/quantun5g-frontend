/**
 * QUANTUM5G — Landing Page institucional do Pentagrama
 * Rota /institucional. Era a rota raiz / antes do P021 (apex shell).
 * Acessível sem login; convida visitantes para /login ou checkout.
 */
